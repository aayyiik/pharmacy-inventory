...
<!-- Button trigger modal -->
  <a href="/pharmacy/create" class="btn btn-primary">Tambah</a>
  <br>
  <br>
    ...
    <div class="row"><div class="col-sm-12"><table id="zero_config" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="zero_config_info">
        ...
        @foreach ($pharmacy as $item)
             <tr role="row" class="odd">
                ...
                <td>{{$item->stok}}</td>
                <td>
                    <a href="pharmacy/edit/{{$item->id}}"><i class=" fas fa-pencil-alt"></i> Edit</a>
                    <a href="pharmacy/delete/{{$item->id}}"><i class=" fas fa-trash"></i> Delete</a>
                </td>
        </tr>
        @endforeach
        </tbody>
