...
<form class="form-horizontal" action="/users/store" method="POST">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="lname" name="email" placeholder="Last Name Here">
            </div>
        </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="email1" name="no_telp" placeholder="Company Name Here">
            </div>
        </div>
        <div class="form-group row">
            <label for="cono1" class="col-sm-3 text-end control-label col-form-label">Alamat</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="cono1" name="address" placeholder="Contact No Here">
            </div>
        </div>
        <div class="form-group row">
